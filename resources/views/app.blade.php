...
<body class="aimeos">
	<nav class="navbar navbar-expand-md navbar-light">
		<a class="navbar-brand" href="/">
			...
			{{-- <h1>GEMGEN</h1> --}}
				<img src="{{ asset('storage/logo.jpg') }}" height="50" title="Business Logo">
		</a>
	...
	<footer class="mt-5 p-5">
		<div class="row">
			...
			<div class="col-md-4 my-4">
				...
				<a class="px-2 py-4 d-inline-block" href="/"><img src="{{ asset('storage/shop.jpg') }}" style="width: 160px" title="Business Logo"></a>
			</div>
		</div>
	</footer>
	<!-- Scripts -->
